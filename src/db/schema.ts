...
export const user = sqliteTable("user", {
  ...
  dailyBasicMessages: integer("daily_basic_messages").default(0).notNull(),
  dailyProMessages: integer("daily_pro_messages").default(0).notNull(),
  basicDailyLimit: integer("basic_daily_limit").default(30).notNull(),
  proDailyLimit: integer("pro_daily_limit").default(3).notNull(),
